...
var CreateForm = forwardRef((_a, ref) => {
  var _b = _a, { placeholder = "\u7559\u4E0B\u8A55\u8AD6" } = _b, props = __objRest(_b, ["placeholder"]);
  ...
  const mutation = useSWRMutation(
    ...
    }, arg)),
    {
      onSuccess: (data2) => {
        ...
        syncComments([data2]);
        (_a2 = editorRef.current) == null ? void 0 : _a2.commands.clearContent(true);
      },
      revalidate: false
    }
  );
      ...
      children: [
        ...
        /* @__PURE__ */ jsx2(
          CommentEditor,
          {
            ...
            onSubmit: submit,
            placeholder,
            children: auth.isLoading || auth.session ? /* @__PURE__ */ jsx2(
              "button",
              {
                "aria-label": "\u767C\u9001",
                className: twMerge(
  ...
  return /* @__PURE__ */ jsxs3(Fragment, { children: [
    /* @__PURE__ */ jsxs3("div", { className: "mt-2 flex flex-row -mx-2", children: [
      /* @__PURE__ */ jsxs3(
        "button",
        {
          ...
          type: "button",
          children: [
            /* @__PURE__ */ jsx4(ThumbsUp, { "aria-label": "\u8B9A", className: "size-4" }),
      ...
      /* @__PURE__ */ jsxs3(
        "button",
        {
          ...
          type: "button",
          children: [
            /* @__PURE__ */ jsx4(ThumbsDown, { "aria-label": "\u5012\u8B9A", className: "size-4" }),
    ...
    isMobile ? /* @__PURE__ */ jsx4(Dialog, { open: isReplying, onOpenChange: setReply, children: /* @__PURE__ */ jsxs3(
      DialogContent,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs3(DialogTitle, { className: "sr-only", children: [
            "\u56DE\u8986 ",
            comment.author.name
          ] }),
          /* @__PURE__ */ jsx4(
        ...
        CommentEditor,
        {
          ...
          children: /* @__PURE__ */ jsx7(
            "button",
            {
              ...
              disabled: mutation.isMutating || isEmpty,
              type: "submit",
              children: mutation.isMutating ? /* @__PURE__ */ jsx7(Spinner, {}) : /* @__PURE__ */ jsx7(Pencil, { className: "size-4" })
            }
          )
        }
      )
...
function Comment(_a) {
  ...
  return /* @__PURE__ */ jsxs4(CommentProvider, { value: context, children: [
    /* @__PURE__ */ jsxs4(
      "div",
      __spreadProps(__spreadValues({}, props), {
        className: twMerge(
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs4("div", { className: "min-w-0 flex-1", children: [
            /* @__PURE__ */ jsxs4("div", { className: "flex flex-row items-center gap-2", children: [
...
function CommentMenu(_a) {
  ...
  return /* @__PURE__ */ jsxs4(Dialog, { open: isEditing, onOpenChange: setIsEditing, children: [
    /* @__PURE__ */ jsxs4(DialogContent, { children: [
      /* @__PURE__ */ jsx8(DialogTitle, { className: "max-sm:sr-only", children: "\u7DE8\u8F2F\u8A55\u8AD6" }),
      /* @__PURE__ */ jsx8(DialogDescription, { className: "max-sm:sr-only", children: "\u7DE8\u8F2F\u60A8\u7684\u8A55\u8AD6\u5167\u5BB9\u3002" }),
      /* @__PURE__ */ jsx8(EditForm, { onClose: () => setIsEditing(false) })
    ] }),
    /* @__PURE__ */ jsxs4(Menu, { children: [
      /* @__PURE__ */ jsx8(
        MenuTrigger,
        __spreadProps(__spreadValues({
          "aria-label": "\u958B\u555F\u9078\u55AE",
      ...
      /* @__PURE__ */ jsxs4(
        MenuItems,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs4(MenuItem, { onSelect: onCopy, children: [
              "\u8907\u88FD",
              /* @__PURE__ */ jsx8(Copy, {})
            ] }),
            canEdit ? /* @__PURE__ */ jsxs4(MenuItem, { onSelect: onEdit, children: [
              "\u7DE8\u8F2F",
              /* @__PURE__ */ jsx8(Pencil, {})
            ] }) : null,
            canDelete ? /* @__PURE__ */ jsxs4(
              MenuItem,
              {
...
function CommentList(_a) {
  ...
  return /* @__PURE__ */ jsxs5("div", __spreadProps(__spreadValues({ ref }, props), { className: twMerge("flex flex-col", props.className), children: [
    !query.isLoading && cursor === void 0 && list.length === 0 && /* @__PURE__ */ jsx9("p", { className: "mx-auto my-4 text-center text-sm text-fc-muted-foreground", children: "\u5C1A\u7121\u8A55\u8AD6" }),
...
function Replies() {
  ...
  if (isMobile) {
    return /* @__PURE__ */ jsxs5(Dialog, { open, onOpenChange: setOpen, children: [
      ...
      /* @__PURE__ */ jsxs5(DialogContent, { className: "h-[70vh]", children: [
        /* @__PURE__ */ jsx9(DialogTitle, { children: "\u8A55\u8AD6" }),
        /* @__PURE__ */ jsx9(
          CommentList,
          {
            threadId: comment.id,
  ...
  return /* @__PURE__ */ jsxs5(Collapsible, { className: "bg-fc-card", open, onOpenChange: setOpen, children: [
